...
public class OddOccurrencesInArrayTest {
	...
	public static void createInput() throws IOException {
		String jsonString = "{\"tests\":[{\"A\":[9,3,9,3,9,7,9],\"output\":7}" + ", {\"A\":[9,3],\"output\":-1}"
				+ ", {\"A\":[9],\"output\":9}" + ", {\"A\":[9,3,9,3,9,9,3],\"output\":3}]}";
	...
	private Context createContext() {
		...
		ctx.setFunctionName("OddOccurrencesInArray");
		return ctx;
	}

	@Test
	public void testLambdaFunctionHandler() {
		OddOccurrencesInArray handler = new OddOccurrencesInArray();

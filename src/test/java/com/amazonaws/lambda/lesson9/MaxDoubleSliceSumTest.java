...
public class MaxDoubleSliceSumTest {
  ...
  private static Supplier<String> createObject = () -> {
    ...
    jsonObject.put("NA", new JSONArray(new Integer[] { 3, 2, 6, -1, 4, 5, -1, 2 }));
    jsonObject.put("output", 17);
    jsonMainArray.put(jsonObject);

    jsonObject = new JSONObject();
    jsonObject.put("NA", new JSONArray(new Integer[] { 5, 17, 0, 3 }));
    jsonObject.put("output", 17);
    jsonMainArray.put(jsonObject);
...
//    jsonMainArray.put(jsonObject);
  ...
  public void testSample() {
    MaxDoubleSliceSum handler = new MaxDoubleSliceSum();

...
public class MaxSliceSumTest {
  ...
  private static Supplier<String> createObject = () -> {
    ...
    jsonObject.put("NA", new JSONArray(new Integer[] { 3, 2, -6, 4, 0 }));
    jsonObject.put("output", 5);
    jsonMainArray.put(jsonObject);

    jsonObject = new JSONObject();
    jsonObject.put("NA", new JSONArray(new Integer[] { 0 }));
    jsonObject.put("output", 0);
    jsonMainArray.put(jsonObject);

    jsonObject = new JSONObject();
    jsonObject.put("NA", new JSONArray(new Integer[] { 3 }));
    jsonObject.put("output", 3);
    jsonMainArray.put(jsonObject);

    jsonObject = new JSONObject();
    jsonObject.put("NA", new JSONArray(new Integer[] { 3, -2, -1 }));
    jsonObject.put("output", 3);
    jsonMainArray.put(jsonObject);
...
//    jsonMainArray.put(jsonObject);
  ...
  public void testSample() {
    MaxSliceSum handler = new MaxSliceSum();
